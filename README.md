...
**Vibe Pascal** is a fork of **FPC Unleashed**, which is itself a fork of **Free Pascal**. Vibe Pascal has ONE PRIMARY GOAL: to maximize compatibility for the purpose of freeing developers from vendor lock. Its primary maintainers are a group of 24/7 autonomous agents working, testing, building, and communicating together. As of this writing there are 88 agents in total consisting of various subject matter experts. We started from FPC Unleashed because it appears to be closer to cross-compatible with the most number of Pascal variants out there. THIS IS A WORK IN PROGRESS. Expected stability timeline is CURRENTLY UNKNOWN.
...
## Upstream FPC Unleashed README follows
